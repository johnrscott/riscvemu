use super::{eei::Eei, rv32i::*, rv32m::*, rv32priv::*, rv32zicsr::*, Instr};
use crate::{
    decode::{Decoder, DecoderError, MaskWithValue},
    opcodes::{
        FUNCT12_MRET, FUNCT3_ADD, FUNCT3_ADDI, FUNCT3_AND, FUNCT3_ANDI,
        FUNCT3_B, FUNCT3_BEQ, FUNCT3_BGE, FUNCT3_BGEU, FUNCT3_BLT, FUNCT3_BLTU,
        FUNCT3_BNE, FUNCT3_BU, FUNCT3_CSRRC, FUNCT3_CSRRCI, FUNCT3_CSRRS,
        FUNCT3_CSRRSI, FUNCT3_CSRRW, FUNCT3_CSRRWI, FUNCT3_DIV, FUNCT3_DIVU,
        FUNCT3_H, FUNCT3_HU, FUNCT3_JALR, FUNCT3_MUL, FUNCT3_MULH,
        FUNCT3_MULHSU, FUNCT3_MULHU, FUNCT3_OR, FUNCT3_ORI, FUNCT3_PRIV,
        FUNCT3_REM, FUNCT3_REMU, FUNCT3_SLL, FUNCT3_SLLI, FUNCT3_SLT,
        FUNCT3_SLTI, FUNCT3_SLTIU, FUNCT3_SLTU, FUNCT3_SRA, FUNCT3_SRAI,
        FUNCT3_SRL, FUNCT3_SRLI, FUNCT3_SUB, FUNCT3_W, FUNCT3_XOR, FUNCT3_XORI,
        FUNCT7_ADD, FUNCT7_AND, FUNCT7_MULDIV, FUNCT7_OR, FUNCT7_SLL,
